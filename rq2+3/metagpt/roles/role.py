...
class Role:
    ...
    def __init__(self, name="", profile="", goal="", constraints="", desc="", is_human=False, personality=""): # [TOMOIKE EDIT]
        self._llm = LLM() if not is_human else HumanProvider()
        self._setting = RoleSetting(name=name, profile=profile, goal=goal,
                                    constraints=constraints, desc=desc, is_human=is_human, personality=personality) # [TOMOIKE EDIT]
        self._states = []
        self._actions = []
    ...
    def _init_actions(self, actions):
        ...
        for idx, action in enumerate(actions):
            if not isinstance(action, Action):
                ...
                i = action
            i.set_prefix(self._get_prefix(), self.profile, self.personality)
    ...
    def personality(self):
        """Get the role description (position)"""
        return self._setting.personality
    # [TOMOIKE EDIT] ===========}
    ...
    async def _think(self) -> None:
        ...
        # print(prompt)
        next_state = await self._llm.aask(prompt, [self.personality + self._llm._default_system_msg()["content"]]) #[TOMOIKE EDIT]
